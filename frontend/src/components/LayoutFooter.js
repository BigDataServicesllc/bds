...
<div className="flex items-center gap-4 justify-start lg:justify-end">
  {/* LinkedIn */}
  <a
    href="https://www.linkedin.com/company/105134255/admin/dashboard/"
    target="_blank"
  ...
  {/* YouTube */}
  <a
    href="https://www.youtube.com/@bigdataservices"
    target="_blank"
    rel="noopener noreferrer"
    className="w-9 h-9 rounded-full bg-bds-aqua flex items-center justify-center text-bds-deep hover:opacity-90 transition-opacity"
    aria-label="YouTube"
  ...
  >
    <svg
      ...
      fill="currentColor"
    >
      <path d="M2 4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h20a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H2zm0 2 10 6 10-6v.01L12 14 2 6.01V6z" />
    </svg>
  </a>
